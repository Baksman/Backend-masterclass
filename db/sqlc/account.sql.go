...
WHERE id = $2 RETURNING id, owner, balance, currency, created_at, country_code
`
...
SELECT id, owner, balance, currency, created_at, country_code FROM account
WHERE id = $1 LIMIT 1
`
...
WHERE id = $1 RETURNING id, owner, balance, currency, created_at, country_code
`
